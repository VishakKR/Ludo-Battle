var move = document.getElementsByClassName('move1');
...
var killsound= document.getElementById("killsound"); 
...
var playzone= document.getElementsByClassName('player');
var playerroom= document.getElementsByClassName('playzone');
...
play.addEventListener("click",function(){
     if(gi.value==""){
       ...
       totalplayer-=1;
         ...
         playername1[1].innerHTML="";
   }else{
       playername[2].innerHTML=gi.value;
       playername1[1].innerHTML=gi.value;
       pp.push('g');
   }
   ...
   if(ri.value==""){
       ...
       playername1[0].innerHTML="";
   }else{
       playername[0].innerHTML=ri.value;
       playername1[0].innerHTML=ri.value;
       pp.push('r');
   }
    ...
    if(yi.value==""){
       ...
       totalplayer-=1;
        ...
        playername1[3].innerHTML="";
   }else{
       playername[3].innerHTML=yi.value;
       playername1[3].innerHTML=yi.value;
       pp.push('y');
   }
    ...
    if(bi.value==""){
       ...
       totalplayer-=1;
        ...
        playername1[2].innerHTML="";
   }else{
       playername[1].innerHTML=bi.value;
       playername1[2].innerHTML=bi.value;
      pp.push('b');
   }
    if(pp[0]=='r'){
...
function winner(pl){
    if(pl=='r'){
        if(totalpr==0){
            ...
            playerroom[0].innerHTML="<img src='win"+winno+".png' class='win'>";
            pmove=7;
            moves[0]=0;
            diceRotation(0);
        }
    ...
    if(pl=='g'){
        if(totalpg==0){
            ...
            playerroom[1].innerHTML="<img src='win"+winno+".png' class='win'>";
             moves[1]=0;
            pmove=7;
            diceRotation(1);
        }
    ...
    if(pl=='b'){
        if(totalpb==0){
            ...
            playerroom[2].innerHTML="<img src='win"+winno+".png' class='win'>";
             moves[3]=0;
            pmove=7;
            diceRotation(3);
        }
    ...
    if(pl=='y'){
        if(totalpy==0){
            ...
            playerroom[3].innerHTML="<img src='win"+winno+".png' class='win'>";
             moves[2]=0;
            pmove=7;
            diceRotation(2);
        }
...
//var cplayer=0;
//$movecount = document.getElementsByClassName("move1");
//        for(i=0;i<$movecount.length;i++){
//            $movecount[i].innerHTML=i;
//        }
...
function kill(pno,p){
    ...
    if(p==0){
        ...
        for(i=0;i<4;i++){
           ...
           var yellow = '<span onclick="moveyellow(this,'+i+')" class="rp material-icons y" style="z-index: 0;">stars</span>'; 
            ...
            var check = move[redpath[rp[pno]]].innerHTML;
    console.log(check);
        if(check==green){
            killsound.play();
            move[redpath[rp[pno]]].innerHTML="";
            gp[i]=-1;
            gstate[i]=0;
            playzone[4+i].innerHTML=green;
            ...
            yp[i]=-1;
            ystate[i]=0;
            playzone[12+i].innerHTML=yellow;
    ...
    if(p==1){
        ...
        for(i=0;i<4;i++){
           var blue = '<span onclick="moveblue(this,'+i+')" class="rp material-icons b" style="z-index: 0;">stars</span>'; 
           var red = '<span onclick="moved(this,'+i+')" class="rp material-icons r" style="z-index: 0;">stars</span>'; 
           var yellow = '<span onclick="moveyellow(this,'+i+')" class="rp material-icons y" style="z-index: 0;">stars</span>'; 
            
            var check = move[greenpath[gp[pno]]].innerHTML;
    console.log(check);
        if(check==red){
            killsound.play();
            move[greenpath[gp[pno]]].innerHTML="";
            rp[i]=-1;
            rstate[i]=0;
            playzone[0+i].innerHTML=red;
    ...
    if(p==2){
        ...
        for(i=0;i<4;i++){
           ...
           var yellow = '<span onclick="moveyellow(this,'+i+')" class="rp material-icons y" style="z-index: 0;">stars</span>'; 
            ...
            var check = move[bluepath[bp[pno]]].innerHTML;
    console.log(check);
        if(check==green){
            killsound.play();
            move[bluepath[bp[pno]]].innerHTML="";
            gp[i]=-1;
            gstate[i]=0;
            playzone[4+i].innerHTML=green;
            console.log("green"+i+" is dead !");
     ...
     if(safeplace.includes(yellowpath[yp[pno]])){
        ...
        for(i=0;i<4;i++){
           ...
           var red = '<span onclick="moved(this,'+i+')" class="rp material-icons r" style="z-index: 0;">stars</span>'; 
            ...
            var check = move[yellowpath[yp[pno]]].innerHTML;
    console.log(check);
        if(check==green){
            killsound.play();
            move[yellowpath[yp[pno]]].innerHTML="";
            gp[i]=-1;
            gstate[i]=0;
            playzone[4+i].innerHTML=green;
            console.log("green"+i+" is dead !");
...
function moved(obj,pno){
    ...
    moves[0]=0;
    if(rp[pno]>-1){
       var prevpl = move[redpath[rp[pno]]].innerHTML; 
    }
    var i;
    for(i=0;i<move.length;i++){
        if(rp[pno]==i){
            movesound.play();
          move[redpath[rp[pno]]].innerHTML="<span onclick='moved(this,"+pno+")' class='rp material-icons r'>stars</span>"+prevpl; 
        }else{
            obj.remove();
        }
//        kill();
...
function movegreen(obj,pno){
    ...
    moves[1]=0;
    if(gp[pno]>-1){
       var prevpl = move[greenpath[gp[pno]]].innerHTML; 
    }
    var i;
    for(i=0;i<move.length;i++){
        if(gp[pno]==i){
            movesound.play();
          move[greenpath[gp[pno]]].innerHTML="<span onclick='movegreen(this,"+pno+")' class='rp material-icons g'>stars</span>"+prevpl; 
        }else{
            obj.remove();
        }
    }
...
function moveblue(obj,pno){
    ...
    moves[3]=0;
    if(bp[pno]>-1){
       var prevpl = move[bluepath[bp[pno]]].innerHTML; 
    }
    var i;
    for(i=0;i<move.length;i++){
        if(bp[pno]==i){
            movesound.play();
          move[bluepath[bp[pno]]].innerHTML="<span onclick='moveblue(this,"+pno+")' class='rp material-icons b'>stars</span>"+prevpl; 
        }else{
            obj.remove();
        }
    }
...
startsound.play();
    ...
    moves[2]=0;
    if(yp[pno]>-1){
       var prevpl = move[yellowpath[yp[pno]]].innerHTML; 
    }
    var i;
    for(i=0;i<move.length;i++){
        if(yp[pno]==i){
            movesound.play();
          move[yellowpath[yp[pno]]].innerHTML="<span onclick='moveyellow(this,"+pno+")' class='rp material-icons y'>stars</span>"+prevpl; 
        }else{
            obj.remove();
        }
    }
